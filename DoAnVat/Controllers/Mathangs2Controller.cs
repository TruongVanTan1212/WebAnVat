...
{
    public class Mathangs2Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public Mathangs2Controller(ApplicationDbContext context)
        {
            _context = context;
        }
